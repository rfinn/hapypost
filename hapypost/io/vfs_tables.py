...
class VTables:
    ...
    def read_all(self):
        ...
        try:
            ...
            print("WARNING: cigale file not found (this is probably ok)")
        self.read_tempel()        
        #self.read_rphot()
        self.read_legacy()
        self.read_ephot()
    ...
    def read_halpha(self):
        ''' 
        read in halpha observations table; store as self.halpha; 

        table is generated from hapy/scripts/make_vfs_hapy_rowmatched.py
    ...
    def read_cigale(self):
        ...
        outtab = self.tabledir+self.tableprefix+'cigale_metallicity_20260305.fits'
        self.cigale = Table.read(outtab)
...
if __name__ == '__main__':
    ...
    print("table directory = ", args.tabledir)
